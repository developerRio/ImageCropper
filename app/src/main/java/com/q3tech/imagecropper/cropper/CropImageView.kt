...
import com.q3tech.imagecropper.cropper.CropOverlayView.CropWindowChangeListener
import com.q3tech.imagecropper.cropper.BitmapCroppingWorkerJob
import com.q3tech.imagecropper.cropper.utils.getFilePathFromUri
...
class CropImageView @JvmOverloads constructor(
  ...
  override fun onCropWindowChanged(inProgress: Boolean) {
    ...
    if (inProgress) {
      ...
      Log.e(TAG, "onCropWindowChanged: inProgress V $inProgress")
      // TODO: send the completion listener from here
